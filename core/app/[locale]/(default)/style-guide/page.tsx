export default function StyleGuidePage() {
  return (
    <div style={{ fontFamily: "'Barlow', sans-serif", background: '#f5f5f5', minHeight: '100vh' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 48 }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
                  <div>
                    <button className="sg-btn-solid-dark-lg">Large Button</button>
                    <BtnLabel name="sg-btn-solid-dark-lg" />
                  </div>
                  <div>
                    <button className="sg-btn-solid-dark-md">Medium Button</button>
                    <BtnLabel name="sg-btn-solid-dark-md" />
                  </div>
                  <div>
                    <button className="sg-btn-solid-dark-sm">Small Button</button>
                    <BtnLabel name="sg-btn-solid-dark-sm" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
                  <div>
                    <button className="sg-btn-outline-dark-lg">Large Button</button>
                    <BtnLabel name="sg-btn-outline-dark-lg" />
                  </div>
                  <div>
                    <button className="sg-btn-outline-dark-md">Medium Button</button>
                    <BtnLabel name="sg-btn-outline-dark-md" />
                  </div>
                  <div>
                    <button className="sg-btn-outline-dark-sm">Small Button</button>
                    <BtnLabel name="sg-btn-outline-dark-sm" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
                  <div>
                    <button className="sg-btn-underline-dark-lg">Large Button</button>
                    <BtnLabel name="sg-btn-underline-dark-lg" />
                  </div>
                  <div>
                    <button className="sg-btn-underline-dark-md">Medium Button</button>
                    <BtnLabel name="sg-btn-underline-dark-md" />
                  </div>
                  <div>
                    <button className="sg-btn-underline-dark-sm">Small Button</button>
                    <BtnLabel name="sg-btn-underline-dark-sm" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div style={{ background: '#ffffff', borderRadius: 16, padding: 48, border: '1px solid #e0e0e0' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 48 }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
                  <div>
                    <button className="sg-btn-solid-lg">Large Button</button>
                    <BtnLabel name="sg-btn-solid-lg" dark />
                  </div>
                  <div>
                    <button className="sg-btn-solid-md">Medium Button</button>
                    <BtnLabel name="sg-btn-solid-md" dark />
                  </div>
                  <div>
                    <button className="sg-btn-solid-sm">Small Button</button>
                    <BtnLabel name="sg-btn-solid-sm" dark />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
                  <div>
                    <button className="sg-btn-outline-lg">Large Button</button>
                    <BtnLabel name="sg-btn-outline-lg" dark />
                  </div>
                  <div>
                    <button className="sg-btn-outline-md">Medium Button</button>
                    <BtnLabel name="sg-btn-outline-md" dark />
                  </div>
                  <div>
                    <button className="sg-btn-outline-sm">Small Button</button>
                    <BtnLabel name="sg-btn-outline-sm" dark />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
                  <div>
                    <button className="sg-btn-underline-lg">Large Button</button>
                    <BtnLabel name="sg-btn-underline-lg" dark />
                  </div>
                  <div>
                    <button className="sg-btn-underline-md">Medium Button</button>
                    <BtnLabel name="sg-btn-underline-md" dark />
                  </div>
                  <div>
                    <button className="sg-btn-underline-sm">Small Button</button>
                    <BtnLabel name="sg-btn-underline-sm" dark />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div style={{ display: 'grid', gap: 16 }}>
            ...
            <div style={{ background: '#014960', borderRadius: 12, padding: 40, display: 'flex', gap: 48, flexWrap: 'wrap', alignItems: 'center' }}>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__lighting_white.svg" alt="CAST Lighting white" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#90a4ae', marginTop: 8 }}>Lighting / White</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__lighting_baby-blue.svg" alt="CAST Lighting baby blue" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#90a4ae', marginTop: 8 }}>Lighting / Baby Blue</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__lighting_mid-blue.svg" alt="CAST Lighting mid blue" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#90a4ae', marginTop: 8 }}>Lighting / Mid Blue</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__landscape_white.svg" alt="CAST Landscape white" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#90a4ae', marginTop: 8 }}>Landscape / White</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__graphic_white.svg" alt="CAST Graphic white" style={{ height: 48 }} />
                <div style={{ fontSize: 11, color: '#90a4ae', marginTop: 8 }}>Graphic / White</div>
              </div>
            </div>
            ...
            <div style={{ background: '#f5f5f5', borderRadius: 12, padding: 40, display: 'flex', gap: 48, flexWrap: 'wrap', alignItems: 'center', border: '1px solid #e0e0e0' }}>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__lighting_black.svg" alt="CAST Lighting black" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#546f7a', marginTop: 8 }}>Lighting / Black</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__lighting_charcoal.svg" alt="CAST Lighting charcoal" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#546f7a', marginTop: 8 }}>Lighting / Charcoal</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__lighting_mid-blue.svg" alt="CAST Lighting mid blue" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#546f7a', marginTop: 8 }}>Lighting / Mid Blue</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__landscape_dark-blue.svg" alt="CAST Landscape dark blue" style={{ height: 36 }} />
                <div style={{ fontSize: 11, color: '#546f7a', marginTop: 8 }}>Landscape / Dark Blue</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img src="/images/logos/cast__graphic_mid-blue.svg" alt="CAST Graphic mid blue" style={{ height: 48 }} />
                <div style={{ fontSize: 11, color: '#546f7a', marginTop: 8 }}>Graphic / Mid Blue</div>
              </div>
            </div>
          </div>
        </Section>
...
function BtnLabel({ name, dark }: { name: string; dark?: boolean }) {
  return (
    <div style={{ fontSize: 10, fontFamily: 'monospace', color: dark ? '#90a4ae' : '#546f7a', marginTop: 6 }}>
      .{name}
    </div>
  )
}
