...
const AboutHero = forwardRef(function AboutHero(
  {
    className,
    bgImage,
    bgColor = "#25262d",
    bgOpacity = 60,
    badgeText = "Our Story",
    heading = "About CAST Lighting",
    headingAccent = "",
    description = "Professional-grade landscape lighting trusted by contractors since 2001.",
  ...
  const overlayOpacity = typeof bgOpacity === "number" ? bgOpacity / 100 : 0.6

  return (
    <section
      ref={ref}
      className={`relative overflow-hidden ${className || ""}`}
      style={{ paddingTop, paddingBottom, zIndex: 2 }}
    >
      {/* Background image */}
      <img
      ...
      <div
        ...
        style={{ background: bgColor || "#25262d", opacity: overlayOpacity, zIndex: 1 }}
      />
