...
runtime.registerComponent(
  lazy(() => import("./HeroBanner")),
  {
    ...
    props: {
      ...
      paddingTop: NumberControl({ label: 'Padding Top', defaultValue: 40, min: 0, max: 400, step: 8, suffix: 'px' }),
      paddingBottom: NumberControl({ label: 'Padding Bottom', defaultValue: 48, min: 0, max: 400, step: 8, suffix: 'px' }),
    },
  }
)
