...
const HeroBanner = forwardRef(function HeroBanner(
  ...
  return (
    <>
      ...
      `}</style>
      <div ref={ref} className={`relative ${className || ""}`} style={{ backgroundColor: bgColor || "#111827", width: "100%", overflow: "visible", zIndex: 1 }}>
        {bgImage && (
        ...
        <div className={`relative z-10 pt-14 ${heroStyle || ""}`}>
          ...
          >
            ...
            <div className="hero-text-content" style={{ maxWidth: "min(42rem, 50vw)", flexShrink: 0 }}>
              ...
              <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl" style={{ fontFamily: "'Urbanist', sans-serif" }}>
                {heading}
              </h1>
